...
<body>
    ...
    <section class="text-gray-600 body-font mr-0 md:mr-28 ml-0 md:ml-28">
      ...
      <!-- Reel videos -->
      <h2 class="mt-20 mb-5 text-center text-5xl text-gray-900 font-extrabold">Recent <span class='text-orange-600'>Clips</span></h2>
      ...
      <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-col items-center border-t pt-6">
          ...
          <nav class="mb-4 flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
            <a href="#" class="text-gray-500 transition duration-100 hover:text-orange-500 active:text-orange-600">About Me</a>
            <a href="#" class="text-gray-500 transition duration-100 hover:text-orange-500 active:text-orange-600">Recent Clips</a>
            <a href="#" class="text-gray-500 transition duration-100 hover:text-orange-500 active:text-orange-600">Events</a>
            <a href="#" class="text-gray-500 transition duration-100 hover:text-orange-500 active:text-orange-600">Contact</a>
          </nav>
          <!-- nav - end -->
